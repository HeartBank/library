...
class Customers {
  ...
  get() {
    return request({
      method: 'GET',
      uri: this.base_url + '/customers/' + this.customer_id,
      qs: {},
      json: true,
      headers: {
...
module.exports = (developer_key, developer_secret, base_url, client_id, auth_token, ids) => new Customers(developer_key, developer_secret, base_url, client_id, auth_token, ids);
